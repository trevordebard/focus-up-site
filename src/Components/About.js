  ...
  return (
    <AboutContainer>
      <LeftContainer>
        <ul>
          <li>
            <StyledFontAwesomeIcon icon="check" /> 100% Free
          </li>
          <li>
            <StyledFontAwesomeIcon icon="check" /> Keeps you Focused
          </li>
          <li>
            <StyledFontAwesomeIcon icon="check" /> Works Across Your Entire
            Computer
          </li>
          <li>
            <StyledFontAwesomeIcon icon="check" /> No Data Sent to the Cloud
          </li>
        </ul>
      </LeftContainer>
      <RightContainer>
